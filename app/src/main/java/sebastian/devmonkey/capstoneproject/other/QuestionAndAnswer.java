...
public class QuestionAndAnswer {
    ...
    private String[] halloweenQuestion = { " Another way to say Halloween is",
    ...
    private String[] internAnswer1 = { " Allhallows Evening ", " November 1 is All Saints' Day ", " ancient customs ", " Both a and c ", "witches are present " };

    private String[] whybarnQuestion= { " The red barn came into existence ", " At first barns weren't painted, because farmer thought paint ", " Farmers started painting their barns because ", " Most farmers mixed their own paint because ", " The article says that a painting mixture was usually made from " };
    ...
    private String[] internAnswer2 = { " during the early 1800s ", " was an unnecessary expense", " the weather ruined wooden buildings", " it saved them money", "skimmed milk, lime, and glue" };



    private String[] acolddayQuestion = { " If the weather is frigid, it is very ?",
    ...
    private String[] internAnswer3 = { " cold",
            " New York",
    ...
    private String[] amysteryQuestion = { " What does Ms. Gervis do with her cakes?",
    ...
    private String[] abrahamQuestion = { " What Where was Lincoln born?",
    ...
    private String[] americanindiannamesQuestion =
    ...
    private String[] americasfirstsculptorQuestion =
    ...
    private String[] americasfirstwomanarchitectQuestion =
    ...
    private String[] benjaminfranklinQuestion =
    ...
    private String[]birdsongsQuestion =
    ...
    private String[] blackamericanQuestion =
    ...
    private String[] blackbearsQuestion =
    ...
    private String[][] internChoices13 = {
        ...
        private String[] blizzardunQuestion =
        ...
        private String[] bluewhaleQuestion =
...
private String[] citynoiseQuestion =
...
private String[] countingQuestion =
...
private String[] discoveryoficecreamQuestion =
...
private String[] doctorinchicagoQuestion =
...
private String[] easterislandQuestion =
...
private String[] garlicsQuestion =
...
private String[] helicoptersQuestion =
        { "   Helicopters are able to…",
        "       When airplanes move upward…",
...
private String[] hibernationQuestion =
...
private String[] howtobepigQuestion =
...
private String[] johncooksQuestion =
...
private String[] internAnswer31 = {  "They live throughout Asia" ,
        "They can wait a long time ","They can wait a long time ","true",
        "true"};

private String[] largestcreatureQuestion =
...
private String[] locksandkeyQuestion =
...
private String[] marcopoloQuestion =
...
private String[] marysfamilyQuestion =
...
private String[] moorishdanceQuestion =
...
private String[] niagaraQuestion =
...
private String[] nutsQuestion =
        ...
        private String[] olympicgameQuestion =
        ...
        private String[] rollerskatesQuestion =
        { "   Joseph Marlin",
        "         First roller skates",
        ...
        private String[]   saltwaterQuestion =
        ...
        private String[]   shirleychsholmQuestion =
        ...
        private String[]   snowballsinspaceQuestion =
        { "    Comets are",
        ...
        private String[]   stagecoachesQuestion =
        ...
        private String[]   terrainQuestion =
        ...
        private String[]   thebrennersQuestion =
        ...
        private String[]   thebusdriverQuestion =
        ...
        private String[]   thenewschoolQuestion =
        ...
        private String[]   theparkQuestion =
        ...
        private String[]   thestoryofmarianQuestion =
        ...
        private String[]   theuscensusQuestion =
        ...
        private String[]   thewhitehouseQuestion =
        ...
        private String[]   threepoliticwarQuestion =
        ...
        private String[]   timewithgranpaQuestion =
        ...
        private String[]   troglodytesQuestion =
        ...
        private String[]   twobestknownQuestion =
        ...
        private String[]   useoftoungeQuestion =
        ...
        private String[]   vetemergencyQuestion =
...
//        private String[]   waterQuestion =
//        { "        The wasp is ",
//        "      		The queen builds a nest",
//        "    The nest is made from ",
//        "         The queen hunts for insects",
//        "         Wasps who are workers"};
//        private String[][] choices73= {
//        {  "an interesting creature ", "an unpopular insect  ",  "a cousin to the bee" , " both a and b"},
//        {  "in autumn ", "in spring ", " in summer" , " none of the above"},
//        {  "insects and eggshells ",  "sticky pulp ",  "cells of a beehive" , " none of the above"},
//        {  "after she builds the nest ", "when the eggs hatch",  "before she deposits the eggs" , " the story does not tell us"},
//        {  "are attended by the queens ", "are killed by the kings",  "are hatched late in the season" , " none of the above"}};
//        private String[] internAnswer73=
//        {  " both a and b", "in spring ", "sticky pulp ",  "when the eggs hatch",  " none of the above"};

        private String[]   worthworkingforQuestion =
        ...
        private String[]   amazonrainforestQuestion =
        ...
        private String[]   articfoxQuestion =
        ...
        private String[]   buffaloQuestion =
        ...
        private String[]   butterfliesQuestion =
        ...
        private String[]   californiacondorQuestion =
        ...
        private String[]   castlesQuestion =
        ...
        private String[]   chicagobearsQuestion =
        ...
        private String[]   christopherrcolumbusbearsQuestion =
        ...
        private String[]   commonloonQuestion =
        ...
        private String[]   cricketQuestion =
        ...
        private String[]   dunkindonutsQuestion =
        ...
        private String[]   mountvesuviusQuestion =
        ...
        private String[]   peregrineQuestion =
        ...
        private String[]   penquinsQuestion =
        ...
        private String[]   planetmarsQuestion =
...
//        " Rainbows are produced when ___________________.",
//        "  What color is NOT in a rainbow? ",
//        "Which of the following IS NOT true?",
//        "    What question is answered in the last paragraph? " };
//        private String[][] choices95= {
//        {  "after the sun sets at night", "after a rainstorm",  "when it snows" , " before a rainstorm"},
//        {  "the sun causes a rainstorm", "the sun comes out after a storm" , "the spectrum causes a rainstorm", " light exits many raindrops at different angles"},
//        {  "pink", "yellow ", "indigo" , "orange" },
//        {  "Double rainbows are two rainbows that are exactly the same.", "Rainbows are usually seen after or during a storm. ", " Spectrum colors sometimes appear in fountains and waterfalls." , "Moon bows are caused by moonlight."},
//        {  "What colors appear in a rainbow?", "How do double rainbows form?  "," How long do rainbows last?" , "Why do waterfalls produce rainbow-like spectrums?"}};
//        private String[] internAnswer95=
//        {  "after a rainstorm",  " light exits many raindrops at different angles" ,"pink"," Spectrum colors sometimes appear in fountains and waterfalls." , "What colors appear in a rainbow?"};

//        private String[]   planetmarsQuestion =
//        {  "Sequoyah invented a language known as the Cherokee syllabary. ",
//        " What word best describes Sequoyah's early life in the eyes of historians?",
//        "  Sequoyah's father was thought to have been a scout for George Washington. ",
//        "Sequoyah was a _______________________.",
//        "   Select all that are true from the choices below: Sequoyah began thinking about a system of written communication… " };
//        private String[][] choices96= {
//        {  "True", "False",  "Maybe" , " Doesn’t say"},
//        {  "unknown", "sad" , "interesting", " light exits many raindrops at different angles"},
//        {  "True", "False",  "Maybe" , " Doesn’t say"},
//        {  "goldsmith", "painter ", " carpenter" , "silversmith"},
//        {  "in 1846.", "in Alabama. ","in Tennessee." , "in 1809."}};
//        private String[] internAnswer96=
//        {  "True",  "unknown", "True" ,"silversmith", "in 1809."};

        private String[]   silkroadQuestion =
...
//        " What is the best meaning of the word \"symptoms\" as used in the following sentence? The flu is a type of virus, which means medicine will only help the symptoms such as the cough and fever.",
//        "Based on the following sentence, which of the following might be another setting where the flu could easily spread? Most kids get the flu in the winter because germs spread more easily when kids are inside in settings such as classrooms.",
//        "   Which of the following WOULD NOT help you in preventing the flu?",
//        "Which sentence has the same meaning as this sentence: For most kids, the flu comes and goes, but for some, it can be a serious illness."};
//        private String[][] choices100= {
//        {  "most kids don't even realize they have the flu.", "the flu can't easily spread from one person to another. ",  "most kids get the flu in winter." , " medicine can help kill the flu."},
//        {  "viruses", "colds ",  "signs" , "medicines"},
//        {  "A city park ", "The baseball field ",  "A day-care center" , " A forest"},
//        {  "Getting a flu shot or flu mist ", "Washing your hands often ", " Keeping your hands to yourself" , "Shaking the hands of your classmates"},
//        {  "For the flu, kids can be a serious illness. ", "For most kids, the flu is a serious illness, but for some, it comes and goes. ", " The flu comes and goes for some kids." , "While the flu can be a serious illness, most kids who get it will recover."}};
//        private String[] internAnswer100=
//        {  "most kids get the flu in winter.",  "signs" ,  "A day-care center" , "Shaking the hands of your classmates", "For most kids, the flu is a serious illness, but for some, it comes and goes. " };
        ...
        if (level.equals("easy")) {
            ...
            if (id == 0) {
                return acolddayQuestion[a];
            } else if (id == 1) {
                return amysteryQuestion[a];
            } else if (id == 2) {
                return abrahamQuestion[a];
            } else if (id == 3) {
                return amazonrainforestQuestion[a];
            } else if (id == 4) {
                return americanindiannamesQuestion[a];
            } else if (id == 5) {
                return americasfirstsculptorQuestion[a];
            } else if (id == 6) {
                return americasfirstwomanarchitectQuestion[a];
            } else if (id == 7) {
                return articfoxQuestion[a];
            } else if (id == 8) {
                return bailQuestion[a];
            } else if (id == 9) {
                return banksQuestion[a];
            } else if (id == 10) {
                return benjaminfranklinQuestion[a];
            } else if (id == 11) {
                return birdsongsQuestion[a];
            } else if (id == 12) {
                return blackamericanQuestion[a];
            } else if (id == 13) {
                return blackbearsQuestion[a];
            } else if (id == 14) {
                return blizzardunQuestion[a];
            } else if (id == 15) {
                return bluewhaleQuestion[a];
            } else if (id == 16) {
                return buffaloQuestion[a];
            } else if (id == 17) {
                return butterfliesQuestion[a];
            } else if (id == 18) {
                return californiacondorQuestion[a];
            } else if (id == 19) {
                return carsQuestion[a];
            } else if (id == 20) {
                return castlesQuestion[a];
            } else if (id == 21) {
                return chicagobearsQuestion[a];
            } else if (id == 22) {
                return christopherrcolumbusbearsQuestion[a];
            } else if (id == 23) {
                return citynoiseQuestion[a];
            } else if (id == 24) {
                return clocksQuestion[a];
            } else if (id == 25) {
                return coinsQuestion[a];
            } else if (id == 26) {
                return commonloonQuestion[a];
            } else if (id == 27) {
                return cornQuestion[a];
            } else if (id == 28) {
                return countingQuestion[a];
            } else if (id == 29) {
                return cricketQuestion[a];
            } else if (id == 30) {
                return null; // dallas cowboys
            } else if (id == 31) {
                return discoveryoficecreamQuestion[a];
            } else if (id == 32) {
                return doctorinchicagoQuestion[a];
            } else if (id == 33) {
                return dunkindonutsQuestion[a];
            } else if (id == 34) {
                return easterislandQuestion[a];
            } else if (id == 35) {
                return garlicsQuestion[a];
            } else if (id == 36) {
                return halloweenQuestion[a];
            } else if (id == 37) {
                return helicoptersQuestion[a];
            } else if (id == 38) {
                return hibernationQuestion[a];
            } else if (id == 39) {
                return housesQuestion[a];
            } else if (id == 40) {
                return howtobepigQuestion[a];
            } else if (id == 41) {
                return johncooksQuestion[a];
            } else if (id == 42) {
                return komodoQuestion[a];
            }
